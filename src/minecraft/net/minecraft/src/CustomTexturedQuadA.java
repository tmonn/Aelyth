...
public class CustomTexturedQuadA
{

    public CustomTexturedQuadA(PositionTextureVertex apositiontexturevertex[])
    {
        nVertices = 0;
        invertNormal = false;
    ...
    public CustomTexturedQuadA(PositionTextureVertex apositiontexturevertex[], int i, int j, int k, int l)
    {
    ...
    public CustomTexturedQuadA(PositionTextureVertex apositiontexturevertex[], int i, int j, int k, int l, int i1, int j1)
    {
        this(apositiontexturevertex);
        float f = 0.0015625F;
        float f1 = 0.003125F;
        float f2 = i1;
        float f3 = j1;
        apositiontexturevertex[0] = apositiontexturevertex[0].setTexturePosition((float)k / f2 - f, (float)j / f3 + f1);
        apositiontexturevertex[1] = apositiontexturevertex[1].setTexturePosition((float)i / f2 + f, (float)j / f3 + f1);
        apositiontexturevertex[2] = apositiontexturevertex[2].setTexturePosition((float)i / f2 + f, (float)l / f3 - f1);
        apositiontexturevertex[3] = apositiontexturevertex[3].setTexturePosition((float)k / f2 - f, (float)l / f3 - f1);
    }
